var googleapi = {
        ...
        //  alert('starting');
            googleapi.authorize({
                                client_id: '882241940431-qsnj4nv4rvcs6huuj4ceesjjmsk06q1f.apps.googleusercontent.com',
                                client_secret: 'L0NxVHRqs3VELsDdQTe9Hfq2',
          ...
          $.ajax({
                   ...
                   success:function(data)
                   {
                       ...
                       console.log(JSON.stringify(data));
                           ...
                           $.ajax({
                               url:'https://www.googleapis.com/plus/v1/people/'+data.id+'?fields=image&key=AIzaSyBXlobVr4rf4zJKBqwj7RCaJYImyEW7eOs',
                               type:'GET',
                               data:term,
                               dataType:'json',
                               error:function(jqXHR,text_status,strError){
                               ...
                               success:function(data2)
                               {
                                    ...
                                    ref.orderByChild('username').equalTo(data.id)
                                        .once('value').then(function(snapshot) {
                                         ...
                                         fbuserExistsCallback(data.given_name,data2.image.url,data.id, exists);
                                    });
                                }
                            });    
