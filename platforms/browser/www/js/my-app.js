...
$$(document).on('pageInit',function(e){
             ...
             questionExistsCallback(user_id, exists,'science_test');
              ...
              pageContainer.find('.submittest').on('click', function () {
                             ...
                             var user_id = $$('.statusbar-overlay').data('userid');
                                 ...
                                 var formData = myApp.formToJSON('#science-test-form');
                                  var i = 0;
                                  var user_exist = [];

                                  var ref = firebase.database().ref("science_test"); //root reference to your data
                                  ref.orderByChild('user_id').equalTo(user_id)
                                      .once('value').then(function(snapshot) {
                                        snapshot.forEach(function(childSnapshot) {
                                           ++i;
                                             firebase.database().ref('science_test/' + childSnapshot.key).set({
                                                    answer: formData['q' + i],
                                                    user_id:user_id ,
                                                    question_number: i
                                                });
                                          ...
                                          myApp.alert('Science test answer Updated!', function () {
                                            mainView.goBack();
                                          });
                                  });
                                  ...
                                  function userExistsCallback(userId, exists) {
                                    if (exists) {
                                      ...
                                      for (var c = 1; c <= 30; c++) {
                                       ...
                                       myApp.alert('Science test answer submitted!', function () {
                                            mainView.goBack();
                                          });
                                    }
                                  }
    ...
    if (page.name === 'mechanical') {
          ...
          var listHTML = '';
          for (var i = 1; i <= 15; i++) {
                     listHTML+='<img src="img/mechanical/q'+i+'.jpg" style="width:100%;" alt="">';
                ...
                $$('#mechanical-data').append(listHTML);
             ...
             questionExistsCallback(user_id, exists,'mechanical_test');
                ...
                pageContainer.find('.submittest').on('click', function () {
                       ...
                       var user_id = $$('.statusbar-overlay').data('userid');
                           ...
                           var formData = myApp.formToJSON('#mechanical-test-form');
                            var i = 0;
                            var user_exist = [];

                            var ref = firebase.database().ref("mechanical_test"); //root reference to your data
                            ref.orderByChild('user_id').equalTo(user_id)
                                .once('value').then(function(snapshot) {
                                  snapshot.forEach(function(childSnapshot) {
                                     ++i;
                                       firebase.database().ref('mechanical_test/' + childSnapshot.key).set({
                                              answer: formData['q' + i],
                                              user_id:user_id ,
                                              question_number: i
                                          });
                            ...
                            function userExistsCallback(userId, exists) {
                              if (exists) {
                                ...
                                for (var c = 1; c <= 15; c++) {
                                      var db = firebase.database();
                                      var ref = db.ref("mechanical_test");
                                      var newPersonalitytestAns = ref.push();
                                      newPersonalitytestAns.set({
                                        answer: formData['q' + c],
                                        user_id:userId ,
                                 ...
                                 myApp.alert('mechanical test answer submitted!', function () {
                                      mainView.goBack();
                                    });
                              }
                            }
    ...
    if (page.name === 'entrepreneurship') {
          ...
          for (var i = 1; i <= 15; i++) {
                ...
                $$('#entrepreneurship-data').append(listHTML);
               ...
               pageContainer.find('.submittest').on('click', function () {
                           ...
                           var formData = myApp.formToJSON('#entrepreneurship-test-form');
                            var i = 0;
                            var user_exist = [];

                            var ref = firebase.database().ref("entrepreneurship_test"); //root reference to your data
                            ref.orderByChild('user_id').equalTo(user_id)
                                .once('value').then(function(snapshot) {
                                  snapshot.forEach(function(childSnapshot) {
                                     ++i;
                                       firebase.database().ref('entrepreneurship_test/' + childSnapshot.key).set({
                                              answer: formData['q' + i],
                                              user_id:user_id ,
                                              question_number: i
                                          });
                            ...
                            function userExistsCallback(userId, exists) {
                              if (exists) {
                                ...
                                for (var c = 1; c <= 15; c++) {
                                 ...
                                 myApp.alert('entrepreneurship test answer submitted!', function () {
                                      mainView.goBack();
                                    });
                              }
                            }
             ...
             questionExistsCallback(user_id, exists,'clerical_test');
                 ...
                 pageContainer.find('.submittest').on('click', function () {
                         ...
                         var user_id = $$('.statusbar-overlay').data('userid');
                             ...
                             var formData = myApp.formToJSON('#clerical-test-form');
                              var i = 0;
                              var user_exist = [];

                              var ref = firebase.database().ref("clerical_test"); //root reference to your data
                              ref.orderByChild('user_id').equalTo(user_id)
                                  .once('value').then(function(snapshot) {
                                    snapshot.forEach(function(childSnapshot) {
                                       ++i;
                                         firebase.database().ref('clerical_test/' + childSnapshot.key).set({
                                                answer: formData['q' + i],
                                                user_id:user_id ,
                                                question_number: i
                                            });
                              ...
                              function userExistsCallback(userId, exists) {
                                if (exists) {
                                  ...
                                  for (var c = 1; c <= 30; c++) {
                                   ...
                                   myApp.alert('clerical test answer submitted!', function () {
                                        mainView.goBack();
                                      });
                                }
                              }
                ...
                pageContainer.find('.submittest').on('click', function () {
                    showloader();
                         var user_id = $$('.statusbar-overlay').data('userid');
                             ...
                             var formData = myApp.formToJSON('#interpersonal-test-form');
                              var i = 0;
                              var user_exist = [];

                              var ref = firebase.database().ref("interpersonal_test"); //root reference to your data
                              ref.orderByChild('user_id').equalTo(user_id)
                                  .once('value').then(function(snapshot) {
                                    snapshot.forEach(function(childSnapshot) {
                                       ++i;
                                         firebase.database().ref('interpersonal_test/' + childSnapshot.key).set({
                                                answer: formData['q' + i],
                                                user_id:user_id ,
                                                question_number: i
                                            });
                              ...
                              function userExistsCallback(userId, exists) {
                                if (exists) {
                                  ...
                                  for (var c = 1; c <= 10; c++) {
                                   ...
                                   myApp.alert('interpersonal test answer submitted!', function () {
                                        mainView.goBack();
                                      });
                                }
                              }
    ...
    if (page.name === 'reasoning') {
          ...
          var listHTML = '';
          for (var i = 1; i <= 30; i++) {
                     listHTML+='<img src="img/reasoning/q'+i+'.jpg" style="width:100%;" alt="">';
                     listHTML+='<div class="list-block"> <ul>';

                     for (var c = 65 , numc = 1;  c <= 69; c++,numc++) {
                        listHTML+='<li><label class="label-radio item-content">';
                ...
                $$('#reasoning-data').append(listHTML);
                ...
                pageContainer.find('.submittest').on('click', function () {
                   showloader();
                         var user_id = $$('.statusbar-overlay').data('userid');
                             ...
                             var formData = myApp.formToJSON('#reasoning-test-form');
                              var i = 0;
                              var user_exist = [];

                              var ref = firebase.database().ref("reasoning_test"); //root reference to your data
                              ref.orderByChild('user_id').equalTo(user_id)
                                  .once('value').then(function(snapshot) {
                                    snapshot.forEach(function(childSnapshot) {
                                       ++i;
                                         firebase.database().ref('reasoning_test/' + childSnapshot.key).set({
                                                answer: formData['q' + i],
                                                user_id:user_id ,
                                                question_number: i
                                            });
                              ...
                              function userExistsCallback(userId, exists) {
                                if (exists) {
                                  ...
                                  for (var c = 1; c <= 30; c++) {
                                   ...
                                   myApp.alert('reasoning test answer submitted!', function () {
                                        mainView.goBack();
                                      });
                                }
                              }
    ...
    if (page.name === 'numericaltest') {
                ...
                pageContainer.find('.submittest').on('click', function () {
                         ...
                         var user_id = $$('.statusbar-overlay').data('userid');
                             ...
                             var formData = myApp.formToJSON('#numerical-test-form');
                              var i = 0;
                              var user_exist = [];

                              var ref = firebase.database().ref("numerical_test"); //root reference to your data
                              ref.orderByChild('user_id').equalTo(user_id)
                                  .once('value').then(function(snapshot) {
                                    snapshot.forEach(function(childSnapshot) {
                                       ++i;
                                         firebase.database().ref('numerical_test/' + childSnapshot.key).set({
                                                answer: formData['q' + i],
                                                user_id:user_id ,
                                                question_number: i
                                            });
                              ...
                              function userExistsCallback(userId, exists) {
                                if (exists) {
                                  ...
                                  for (var c = 1; c <= 30; c++) {
                                   ...
                                   myApp.alert('Numerical test answer submitted!', function () {
                                        mainView.goBack();
                                      });
                                }
                              }
