    ...
    if (page.name === 'results') {
     ...
     if (page.name === 'verbaltest') {
          var pageContainer = $$(page.container);
            ...
            var listHTML = '';
            for (var i = 1; i <= 20; i++) {
                       listHTML+='<img src="img/q'+i+'.jpg" style="width:100%;" alt="">';
                       listHTML+='<div class="list-block"> <ul>';
                       for (var c = 65 , numc = 1;  c <= 68; c++,numc++) {
                          listHTML+='<li><label class="label-radio item-content">';

                          listHTML+=' <input type="radio" name="q'+i+'" value="'+String.fromCharCode(c)+'"';
                            if (c == 65) {
                               listHTML+= 'checked';
                            }
                          listHTML+='>';
                           ...
                           listHTML+= '<div class="item-title">'+String.fromCharCode(c)+'</div></div></label></li> ';
                       }    
                      listHTML += '</ul></div>';           
            }
                  $$('#verbaldata').append(listHTML);

            var listHTML2 = '';
            for (var i = 21; i <= 25; i++) {
                       listHTML2+='<img src="img/q'+i+'.jpg" style="width:100%;" alt="">';
                       listHTML2+='<div class="list-block"> <ul>';
                       for (var c = 65 , numc = 1;  c <= 68; c++,numc++) {
                          listHTML2+='<li><label class="label-radio item-content">';

                          listHTML2+=' <input type="radio" name="q'+i+'" value="'+String.fromCharCode(c)+'"';
                            if (c == 65) {
                               listHTML2+= 'checked';
                            }
                          listHTML2+='>';
                                
                           listHTML2+='<div class="item-media"> <i class="icon icon-form-radio"></i></div><div class="item-inner">';
                           listHTML2+= '<div class="item-title">'+String.fromCharCode(c)+'</div></div></label></li> ';
                       }    
                      listHTML2 += '</ul></div>';           
            }
                  $$('#sentence_correction').append(listHTML2); 


                  var listHTML3 = '';
                  for (var i = 26; i <= 35; i++) {
                             listHTML3+='<img src="img/q'+i+'.jpg" style="width:100%;" alt="">';
                             listHTML3+='<div class="list-block"> <ul>';
                             for (var c = 65 , numc = 1;  c <= 68; c++,numc++) {
                                listHTML3+='<li><label class="label-radio item-content">';

                                listHTML3+=' <input type="radio" name="q'+i+'" value="'+String.fromCharCode(c)+'"';
                                  if (c == 65) {
                                     listHTML3+= 'checked';
                                  }
                                listHTML3+='>';
                                      
                                 listHTML3+='<div class="item-media"> <i class="icon icon-form-radio"></i></div><div class="item-inner">';
                                 listHTML3+= '<div class="item-title">'+String.fromCharCode(c)+'</div></div></label></li> ';
                             }    
                            listHTML3 += '</ul></div>';           
                  }

                  $$('#vocabulary').append(listHTML3);



                    var listHTML4 = '';
                  for (var i = 36; i <= 39; i++) {
                             listHTML4+='<img src="img/q'+i+'.jpg" style="width:100%;" alt="">';
                             listHTML4+='<div class="list-block"> <ul>';
                             for (var c = 65 , numc = 1;  c <= 68; c++,numc++) {
                                listHTML4+='<li><label class="label-radio item-content">';

                                listHTML4+=' <input type="radio" name="q'+i+'" value="'+String.fromCharCode(c)+'"';
                                  if (c == 65) {
                                     listHTML3+= 'checked';
                                  }
                                listHTML4+='>';
                                      
                                 listHTML4+='<div class="item-media"> <i class="icon icon-form-radio"></i></div><div class="item-inner">';
                                 listHTML4+= '<div class="item-title">'+String.fromCharCode(c)+'</div></div></label></li> ';
                             }    
                            listHTML4 += '</ul></div>';           
                  }

                  $$('#readingcomprehension').append(listHTML4);



                  var listHTML5 = '';
                  for (var i = 40; i <= 44; i++) {
                             listHTML5+='<img src="img/q'+i+'.jpg" style="width:100%;" alt="">';
                             listHTML5+='<div class="list-block"> <ul>';
                             for (var c = 65 , numc = 1;  c <= 68; c++,numc++) {
                                listHTML5+='<li><label class="label-radio item-content">';

                                listHTML5+=' <input type="radio" name="q'+i+'" value="'+String.fromCharCode(c)+'"';
                                  if (c == 65) {
                                     listHTML5+= 'checked';
                                  }
                                listHTML5+='>';
                                      
                                 listHTML5+='<div class="item-media"> <i class="icon icon-form-radio"></i></div><div class="item-inner">';
                                 listHTML5+= '<div class="item-title">'+String.fromCharCode(c)+'</div></div></label></li> ';
                             }    
                            listHTML5 += '</ul></div>';           
                  }

                  $$('#readingcomprehension2').append(listHTML5);


                  var listHTML6 = '';
                  for (var i = 45; i <= 48; i++) {
                             listHTML6+='<img src="img/q'+i+'.jpg" style="width:100%;" alt="">';
                             listHTML6+='<div class="list-block"> <ul>';
                             for (var c = 65 , numc = 1;  c <= 68; c++,numc++) {
                                listHTML6+='<li><label class="label-radio item-content">';

                                listHTML6+=' <input type="radio" name="q'+i+'" value="'+String.fromCharCode(c)+'"';
                                  if (c == 65) {
                                     listHTML6+= 'checked';
                                  }
                                listHTML6+='>';
                                      
                                 listHTML6+='<div class="item-media"> <i class="icon icon-form-radio"></i></div><div class="item-inner">';
                                 listHTML6+= '<div class="item-title">'+String.fromCharCode(c)+'</div></div></label></li> ';
                             }    
                            listHTML6 += '</ul></div>';           
                  }

                  $$('#readingcomprehension3').append(listHTML6);


                  var listHTML7 = '';
                  for (var i = 49; i <= 52; i++) {
                             listHTML7+='<img src="img/q'+i+'.jpg" style="width:100%;" alt="">';
                             listHTML7+='<div class="list-block"> <ul>';
                             for (var c = 65 , numc = 1;  c <= 68; c++,numc++) {
                                listHTML7+='<li><label class="label-radio item-content">';

                                listHTML7+=' <input type="radio" name="q'+i+'" value="'+String.fromCharCode(c)+'"';
                                  if (c == 65) {
                                     listHTML7+= 'checked';
                                  }
                                listHTML7+='>';
                                      
                                 listHTML7+='<div class="item-media"> <i class="icon icon-form-radio"></i></div><div class="item-inner">';
                                 listHTML7+= '<div class="item-title">'+String.fromCharCode(c)+'</div></div></label></li> ';
                             }    
                            listHTML7 += '</ul></div>';           
                  }

                  $$('#readingcomprehension4').append(listHTML7);


                   var listHTML8 = '';
                  for (var i = 53; i <= 55; i++) {
                             listHTML8+='<img src="img/q'+i+'.jpg" style="width:100%;" alt="">';
                             listHTML8+='<div class="list-block"> <ul>';
                             for (var c = 65 , numc = 1;  c <= 68; c++,numc++) {
                                listHTML8+='<li><label class="label-radio item-content">';

                                listHTML8+=' <input type="radio" name="q'+i+'" value="'+String.fromCharCode(c)+'"';
                                  if (c == 65) {
                                     listHTML8+= 'checked';
                                  }
                                listHTML8+='>';
                                      
                                 listHTML8+='<div class="item-media"> <i class="icon icon-form-radio"></i></div><div class="item-inner">';
                                 listHTML8+= '<div class="item-title">'+String.fromCharCode(c)+'</div></div></label></li> ';
                             }    
                            listHTML8 += '</ul></div>';           
                  }

                  $$('#readingcomprehension5').append(listHTML8);


                              

                  pageContainer.find('.submittest').on('click', function () {
                   var user_id = $$('.statusbar-overlay').data('userid');

                       var formData = myApp.formToJSON('#verbal-test-form');
                        var i = 0;
                        var user_exist = [];

                        var ref = firebase.database().ref("verbal_test"); //root reference to your data
                        ref.orderByChild('user_id').equalTo(user_id)
                            .once('value').then(function(snapshot) {
                              snapshot.forEach(function(childSnapshot) {
                                 ++i;
                                   firebase.database().ref('verbal_test/' + childSnapshot.key).set({
                                          answer: formData['q' + i],
                                          user_id:user_id ,
                                          question_number: i
                                      });
                        ...
                        function userExistsCallback(userId, exists) {
                          if (exists) {
                            ...
                            for (var c = 1; c <= 20; c++) {
                             ...
                             showloader();
                             myApp.alert('Verbal test answer submitted!', function () {
                                  mainView.goBack();
                                });  
                          }
                        }
